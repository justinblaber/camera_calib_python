...
__all__ = ['pm2l', 'ps2l', 'pld', 'is_p_in_bb', 'is_bb_in_bb', 'CPRefiner', 'CheckerRefiner', 'checker_opencv',
           'OpenCVCheckerRefiner', 'EllipseRefiner', 'fit_conic', 'ellipse_dualconic', 'DualConicEllipseRefiner']
    ...
    def refine_points(self, arr, ps, bs):
        ...
        for idx, (p, b) in enumerate(zip(ps, bs)):
            ...
            for it in range(self.cutoff_it):
                ...
                if np.linalg.norm(p-p_prev) < self.cutoff_norm:
                    break
                b = b-p_prev+p # Update boundary location
            ps_refined.append(p)
